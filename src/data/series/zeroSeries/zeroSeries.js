...

		{
			...
			sections: [
				...
				},
				{
					type: 'text',
					content:
						'Но государственная политика стала двигаться совсем в другом направлении. Елена Жемкова впервые отчетливо осознала новый тренд в 2005 году — во время празднования юбилея окончания Великой Отечественной войны. «это стало так ярко: всё больше говорили о победе — и всё меньше о её цене, — поясняет она. — Но ведь нельзя забывать о трагедии гражданского населения. О вдовах, которые всю жизнь прожили без мужей. О детях, которые потеряли отцов».',
				},
				{
					type: 'text',
					content:
