...
const thirdSeries = {
	...
	previewDiscription:
		'В ноябре 2021 года исполнительный директор «Мемориала» Елена Жемкова получила извещение из Верховного Суда: Генеральная прокуратура просит ликвидировать «Мемориал». Такой же иск получил и Правозащитный центр. Защищать «Мемориал» в суде готовятся лучшие юристы и адвокаты страны. Для многих это станет главным процессом в жизни.',
