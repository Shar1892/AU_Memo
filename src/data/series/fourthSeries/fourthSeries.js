...
const fourthSeries = {
	...
	previewDiscription:
		'«Мемориал» продолжает работать, несмотря на ликвидацию юридического лица. Правозащитники пытаются сохранить команду, здание и архивы. Но 24 февраля Владимир Путин вводит войска в Украину — и уже 5 марта в «Мемориал» приходят с обыском. Полицейские оставляют правозащитникам символ «новой» России — литеру «Z». В октябре «Мемориал» становится одним из лауреатов Нобелевской премии мира.',
