...
import dubrovskiyPhoto from './images/DDubrovskiy.jpg';
...
const firstSeries = {
	...
	previewDiscription:
		'В 2011 году Москву охватили протесты против фальсификации результатов выборов в Госдуму. Государство ответило репрессивным Законом об «иностранных агентах». Питерская прокуратура потребовала, чтобы Антидискриминационный центр «Мемориал» признал себя «иноагентом». Но правозащитники ответили отказом — и решили бороться.',
...

		{
			...
			sections: [
				...
				},
				{
					...
					autor: 'Дмитрий Дубровский, историк',
					autorsPhoto: dubrovskiyPhoto,
				},
				{
					type: 'text',
					content:
